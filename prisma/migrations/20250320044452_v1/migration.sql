                                  ...
                                  "name" TEXT NOT NULL,
                                              "dateOfBirth" TIMESTAMP(3) NOT NULL,
                                                                         "aadharNumber" TEXT NOT NULL,
                                                                                             "proctorId" TEXT, CONSTRAINT "Student_pkey" PRIMARY KEY ("id"));

-- CreateTable

CREATE TABLE "professor" ("professorId" TEXT NOT NULL,
                                             "name" TEXT NOT NULL,
...
CREATE TABLE "LibraryMembership" ("id" TEXT NOT NULL,
...
ALTER TABLE "Student" ADD CONSTRAINT "Student_proctorId_fkey"
FOREIGN KEY ("proctorId") REFERENCES "professor"("professorId") ON
DELETE
SET NULL ON
UPDATE CASCADE;
...
ALTER TABLE "LibraryMembership" ADD CONSTRAINT "LibraryMembership_studentId_fkey"
FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON
DELETE RESTRICT ON
UPDATE CASCADE;
